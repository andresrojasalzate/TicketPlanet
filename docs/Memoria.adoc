...
== CONCLUSIÓN 
=== Adrian Bernabeu
Lo que he aprendido de este proyecto ha sido la creacion de una pagina con laravel utilizando docker, y utilizar el Redsys y configurarlo, lo que me esperaba aprender era lo basico del docker la creacion de contenedores y almacenar los datos y en laravel tambien lo basico.

...
Users "1" -- "0...n" Events
Events "1" -- "0...n" Sessions : event_id
Categories "1" -- "0...n" Events
Events "1" -- "1" Users : user_id
Sessions "1" -- "0...n" Tickets : session_id
Events "0...n" -- "1" Categories : category_id
Events "0...n" -- "1" Users : user_id
Tickets "1" -- "0...n" Sessions : session_id
----
